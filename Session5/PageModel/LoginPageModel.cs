...
namespace PageModel
{
    ...
    public class LoginPageModel : BaseSeleniumPageModel
    {
        ...
        {
            get { return this.GetLazyElement(Body, By.CssSelector("#Login"), "Login button"); }
        }
        ...
        public HomePageModel LoginWithValidCredentialsNoLazy(string userName, string password)
        {
            this.WebDriver.Wait().ForClickableElement(By.CssSelector("#name")).SendKeys(userName);
            this.WebDriver.Wait().ForClickableElement(By.CssSelector("#pw")).SendKeys(password);
            this.WebDriver.Wait().ForClickableElement(By.CssSelector("#Login")).Click();
